...
public class LoginController {
    ...
    public String addnewbranch(BranchDto branchDto, Model model) throws IOException {
        ...
        Path path = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\Branches\\" + branchDto.getName() + System.currentTimeMillis());
...
//        System.out.println("this is file===========");
    ...
    public String addnewbike(BikeDto bikeDto, Model model) throws IOException {
        ...
        Path path = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\front\\" + bikeDto.getBikename() + System.currentTimeMillis());

        String frontfile = path.getFileName().toString();
        bikeDto.setFrontview(frontfile);

        byte[] bytes1 = bikeDto.getLeft().getBytes();
        Path path1 = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\left\\" + bikeDto.getBikename() + System.currentTimeMillis());

        String leftfile = path1.getFileName().toString();
        bikeDto.setLeftview(leftfile);

        byte[] bytes2 = bikeDto.getRight().getBytes();
        Path path2 = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\right\\" + bikeDto.getBikename() + System.currentTimeMillis());

        String rightfile = path2.getFileName().toString();
        bikeDto.setRightview(rightfile);

        byte[] bytes3 = bikeDto.getBack().getBytes();
        Path path3 = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\back\\" + bikeDto.getBikename() + System.currentTimeMillis());
    ...
    public String registration(Model model, UserRegisterDto userRegisterDto, FollowUpDto followUpDto) throws IOException {
        ...
        String imagePath = "C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\profile\\dummy-profile-pic.png";
        byte[] bytes = Files.readAllBytes(Paths.get(imagePath));
        Path path = Paths.get("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\profile\\" + userRegisterDto.getName() + System.currentTimeMillis());
        Files.write(path, bytes);
    ...
    public void getpic(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        ...
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\right\\"+imges);
    ...
    @RequestMapping("/getpic1")
    public void getpic1(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\access\\"+imges);
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
    ...
    public void getpicofbranch(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\Branches\\"+imges);
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
    ...
    public void getpicleft(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\left\\"+imges);
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
    ...
    public void getpicfront(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\front\\"+imges);
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
    ...
    public void getpicback(@RequestParam("imges")String imges,Model model,HttpServletResponse response) throws IOException {
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\back\\"+imges);
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
    ...
    public void prfilePic(@RequestParam("email")String email,Model model,HttpServletResponse response) throws IOException {
        ...
        response.setContentType("image/jpg");
        File file=new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\profile\\"+userReristerEntity.getProfile());
        InputStream in=new BufferedInputStream(new FileInputStream(file));
        ServletOutputStream out = response.getOutputStream();
        IOUtils.copy(in,out);
        response.flushBuffer();
