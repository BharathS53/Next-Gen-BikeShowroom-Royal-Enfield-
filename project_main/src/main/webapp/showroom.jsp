        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="bikes.jsp">Models You Must Explore</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Get Your Accessories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="showrooms.jsp">Find Loaction</a>
                    </li>
                </ul>
            </div>
        </div>
